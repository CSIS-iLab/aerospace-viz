...
import spaceportsMetaInfo from './data/spaceports-meta.csv'
import spaceportsLaunches from './data/launches.csv'
import spaceportsInclinations from './data/inclinations.csv'
