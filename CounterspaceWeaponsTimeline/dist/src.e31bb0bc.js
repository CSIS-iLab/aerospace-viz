...
function parseData(_ref) {
  var src = _ref.src;
  var valuePromise = fetchCSV(src);
  var data = Promise.all([valuePromise]).then(function (res) {
    var _res = (0, _slicedToArray2.default)(res, 1),
        valueData = _res[0];

    var years = valueData.filter(function (d) {
      return d.year > 0;
    }).map(function (d) {
      return d.year;
    }).sort();
...
},{}],"img/css-icons/hamburger.svg":[function(require,module,exports) {
module.exports = "/hamburger.2f717bcf.svg";
...
},{}],"img/css-icons/other-DetailsFlag.svg":[function(require,module,exports) {
module.exports = "/other-DetailsFlag.351af413.svg";
},{}],"img/css-icons/other.svg":[function(require,module,exports) {
module.exports = "/other.4fff16cd.svg";
...
if (window.location.href.indexOf('aerospace') != -1) {
  url = 'https://csis-ilab.github.io/aerospace-viz/CounterspaceWeaponsTimeline/dist/';
}
...
function drawChart() {
  ...
  function generateTimelineEntry(d) {
    ...
    if (d.storyBool) {
      ...
      storyInfo = "<div class=\"action__details-body\">".concat(d.story, "</div>").concat(detailsImage);
    }

    if (d.learnMore) {
      learnMore = "<a href=\"".concat(d.learnMoreURL, "\" class=\"action__details-link\" target=\"_blank\">Explore &#8594;</a>");
    }

    var sourceInfo = "<h2 class=\"action__source-label\">Source</h2><p class=\"action__source\">".concat(d.source, "</p>");
    var moreInfo = "\n      <summary><span class=\"sr-only\">".concat(btnLabel, "</span></summary>\n      <div class=\"action__details-inner\">\n        ").concat(storyInfo, "\n        ").concat(learnMore, "\n        ").concat(sourceInfo, "\n      </div>\n    ");
    var actionDate;
    var actionEndDate;
...
var selectors = {
  setup: function setup(_ref) {
    ...
    var selectEl = d3.select(selector).attr('name', name).on('change', onChange); // Can remove onChange if we use apply button
  ...
  setup: function setup(_ref) {
    ...
    selectEl.selectAll('.checkbox-container').data(data).join(function (enter) {
      return enter.append('div').attr('class', 'checkbox-container').attr('data-category', function (d) {
        ...
        d3.select(this).append('button').attr('class', 'checkbox-expander').text('+');
...
exports.default = _default;
},{"d3-selection":"../node_modules/d3-selection/src/index.js"}],"../node_modules/nouislider/distribute/nouislider.js":[function(require,module,exports) {
var define;
...
exports.default = _default;
},{"nouislider":"../node_modules/nouislider/distribute/nouislider.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/nouislider/distribute/nouislider.min.css":[function(require,module,exports) {
...
var _timeline = _interopRequireDefault(require("./js/timeline"));
...
var dataSrc = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR2JDQ4Sz-mqm1dsVfKT2vF9rINxli4Gm79FYFUZas7AzpgJwkW9jJ1ct7tuMHukwWJEH8qjAGIzfu8/pub?gid=1692795147&single=true&output=csv';
var data;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var apply = document.querySelector('#filter-apply');
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","./js/data":"js/data.js","./js/chart":"js/chart.js","./js/dropdown":"js/dropdown.js","./js/checkbox":"js/checkbox.js","./js/timeline":"js/timeline.js","nouislider/distribute/nouislider.min.css":"../node_modules/nouislider/distribute/nouislider.min.css","./scss/main.scss":"scss/main.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
